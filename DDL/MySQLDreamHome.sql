...
INSERT INTO staff (staffno, fname, lname, position, sex, dob, salary, branchno) VALUES
('SG37', 'Ann', 'Beech', 'Assistant', 'F', '1970-11-10', 12000, 'B003');
INSERT INTO staff (staffno, fname, lname, position, sex, dob, salary, branchno) VALUES
...
('CR56', 'PA14', '2013-5-24', 'too small');
INSERT INTO viewing (clientno, propertyno, viewdate, comment1) VALUES
('CR76', 'PG4', '2013-4-20', 'too remote');
INSERT INTO viewing (clientno, propertyno, viewdate, comment1) VALUES
('CR56', 'PG4', '2013-5-26', NULL);
INSERT INTO viewing (clientno, propertyno, viewdate, comment1) VALUES
('CR62', 'PA14', '2013-5-14', 'no dining room');
INSERT INTO viewing (clientno, propertyno, viewdate, comment1) VALUES
('CR56', 'PG36', '2013-4-28', NULL);


INSERT INTO Registration (clientno, branchno, staffno, datejoined) VALUES
('CR76', 'B005', 'SL41', '2013-1-2');
INSERT INTO Registration (clientno, branchno, staffno, datejoined) VALUES
('CR56', 'B003', 'SG37', '2012-4-11');
INSERT INTO Registration (clientno, branchno, staffno, datejoined) VALUES
('CR74', 'B003', 'SG37', '2011-11-16');
INSERT INTO Registration (clientno, branchno, staffno, datejoined) VALUES
('CR62', 'B007', 'SA9', '2012-3-7');branch